          ...
          <div style={{ padding: '40px 24px', textAlign: 'center' }}>
            ...
            >
              ...
              <div style={{ fontSize: 16, fontWeight: 800, color: '#166534', marginBottom: 8 }}>
                {t('repair.ticketSuccess')}
              </div>
              <div style={{ fontSize: 36, fontWeight: 800, color: '#166534', letterSpacing: 1, marginBottom: 4 }}>
                #{ticket}
              </div>
          ...
          <form onSubmit={handleSubmit} noValidate>
                ...
                {CATEGORIES.map(cat => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        background: selected ? '#FEE2E6' : 'var(--card)',
                        border: `1.5px solid ${selected ? 'var(--r)' : 'var(--border)'}`,
                    ...
                    >
                      ...
                      <div
                        style={{
                          fontSize: 11,
                          fontWeight: 700,
                          color: selected ? 'var(--r)' : 'var(--t2)',
                        }}
                      >
                        {t(`repair.categories.${cat}`)}
                      </div>
                    </button>
                  );
                })}
            ...
            <div className="form-group">
              ...
              <div className="photo-zone">
                ...
                >
                  <Camera size={28} strokeWidth={1.8} color="#8B5E5A" />
                </div>
                ...
                <div className="photo-previews">
                  {previews.map((src, i) => (
                    <div key={i} className="photo-thumb">
                      ...
                      <div className="photo-del" onClick={() => removePhoto(i)}>
                        ✕
                      </div>
                    </div>
                  ))}
